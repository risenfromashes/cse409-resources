    ...
    \begin{tikzpicture}[scale=0.6]
        ...
        \begin{tikzpicture}[scale=0.3]
          ...
          \foreach \x in {0,0.25,...,2.75} {
            \foreach \y in {0,0.25,...,1.75} {
              \fill[gray!20] (\x,\y) rectangle ++(0.2,0.2);
            }
          }
          ...
          \begin{scope}
            ...
            \foreach \x in {0,0.25,...,2.75} {
              \foreach \y in {0,0.25,...,1.75} {
                \fill[AccentColor!40] (\x,\y) rectangle ++(0.2,0.2);
              }
            }
          \end{scope}
        \end{tikzpicture}%
      };
      \node at (12,0) {\scriptsize In/Out Fragments};
      ...
      \node (fragPic) at (16,1.5) {%
        \begin{tikzpicture}[scale=0.3]
          ...
          \foreach \x in {0,0.25,...,2.75} {
            \foreach \y in {0,0.25,...,1.75} {
              \fill[AccentColor!20] (\x,\y) rectangle ++(0.2,0.2);
            }
          }
          ...
          \begin{scope}
            ...
            \foreach \x in {0,0.25,...,2.75} {
              \foreach \y in {0,0.25,...,1.75} {
                \fill[PrimaryColor!60] (\x,\y) rectangle ++(0.2,0.2);
              }
            }
          \end{scope}
        \end{tikzpicture}%
