  ...
  \begin{columns}
    ...
    \begin{column}{0.7\textwidth}
      \begin{raybox}{Rasterization}
        ...
        \textbf{Output:} Fragments with interpolated attributes
  ...
  \begin{columns}
    ...
    \begin{column}{0.3\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        \node[below left] at (3,0.5) {\scriptsize Bounding box};
        ...
        % bounding box
        \draw[thick, RayColor] (0.5,1) rectangle (3,3);
  ...
  \begin{columns}
    ...
    \begin{column}{0.3\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        % Area labels
        \node at (0.9,1.2) {\scriptsize $\beta$};
        \node at (1.8,1.2) {\scriptsize $\alpha$};
  ...
  \begin{columns}
    ...
    \begin{column}{0.7\textwidth}
      \begin{mathbox}{Depth Value Generation}
        ...
        \vspace{0.2cm}
        \textbf{Usage:} Depth testing, early Z rejection
      \end{mathbox}
    \end{column}
    \begin{column}{0.3\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        % 3D triangle
        \fill[ObjectColor!50, opacity=0.7] (A3d) -- (B3d) -- (C3d) -- cycle;
        ...
        \node[left,xshift=-0.5cm] at (C) {\scriptsize $z_C$};
