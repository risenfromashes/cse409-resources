    ...
    \begin{column}{0.5\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        \begin{scope}[shift={(0,-2)}]
          ...
          \node[right] at (2.1,1.25) {\scriptsize Init: $\infty$};

          % Step 2
          \draw[PrimaryColor] (-1,0.5) rectangle (2,1);
          \node[left] at (-1.2,0.75) {\scriptsize 2.};
          \node[right] at (2.1,0.75) {\scriptsize A: $0.3 < \infty \rightarrow \text{store}$};

          % Step 3
          \draw[PrimaryColor] (-1,0) rectangle (2,0.5);
          \node[left] at (-1.2,0.25) {\scriptsize 3.};
          \node[right] at (2.1,0.25) {\scriptsize B: $0.7 > 0.3 \rightarrow \text{discard}$};
        \end{scope}
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \begin{tikzpicture}[scale=0.8]
        ...
        \node[left] at (-0.6,1.51) {\scriptsize $\approx$ Precision};
