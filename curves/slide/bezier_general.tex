  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{conceptbox}{Bézier Properties}
        ...
        \textbf{3. Variation Diminishing:}
        \begin{itemize}
          \item Curve doesn't oscillate more than control polygon
          \item Smooth, well-behaved curves
        \end{itemize}

        \textbf{4. Affine Invariance:}
        \begin{itemize}
    ...
    \begin{column}{0.6\textwidth}
      \begin{conceptbox}{Intuitive Control}
        ...
        \begin{itemize}
          ...
          \item Well-conditioned algorithms
