        ...
        \begin{columns}
            \begin{column}{0.65\textwidth}
                \begin{mathbox}{Determinant Interpretation}
                    ...
                    \only<2>{
                        \begin{itemize}
                            \item $\mathbf{N}$ is the normal vector of the triangle scaled by twice the area.
                            \item $\mathbf{N} \cdot \mathbf{R}_d$ is the projected area of the triangle 
                ...
                \begin{tikzpicture}[scale=0.5]
                    ...
                    \only<2->{    
                        \begin{scope}[
                            ...
                            \coordinate (A) at (-1.556,-1.2);
                            \coordinate (B) at (1.273,-1.2);
                            \coordinate (C) at (-0.141,1.8);
                            \draw[thick, red, fill=red!15, opacity=0.3] (A) -- (B) -- (C) -- cycle;
                        \end{scope}
