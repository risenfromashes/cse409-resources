    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            \begin{mathbox}{Approach}
                \only<1-2>{
                    \textbf{Step 1:} Consider $x$ axis first. There are two planes:
                    \alt<2>{
                        \begin{align*}
                ...
                \only<3>{
                    ...
                    \begin{align*}
                        t_{\text{min},x} &= - \frac{D + \mathbf{n}\cdot \mathbf{R_o}}{\mathbf{n}\cdot \mathbf{R_d}} \\
                                &= - \frac{-z_{\text{min}} + R_{oz}}{R_{dz}} \\
                        t_{\text{min},x} &= \frac{z_{\text{min}} - R_{oz}}{R_{dz}} 
                    \end{align*}
                    Similarly,
                    \begin{align*}
                        t_{\text{max},x} &= \frac{z_{\text{max}} - R_{oz}}{R_{dz}}
                    \end{align*}
                }
                \only<4>{
                ...
                \only<5->{
                    ...
                    \begin{tikzpicture}
                        ...
                        \node[blue, below] at (2.2,0)   {\footnotesize $t_{\min,x}$};
                        \node[blue, below] at (-1.8,0)  {\footnotesize $t_{\max,x}$};
        ...
        \begin{column}{0.45\textwidth}
            ...
            \begin{tikzpicture}[->, scale=0.5]
                ...
                \only<3->{
                    \fill[PrimaryColor!80] (Pz1) circle (2pt) node[below right] {$\mathbf{t}_{\text{min},z}$};
                    \fill[PrimaryColor!80] (Pz2) circle (2pt) node[below right] {$\mathbf{t}_{\text{max},z}$};
                }
                \only<4->{
